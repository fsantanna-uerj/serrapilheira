...
Figure~\ref{lst.direct}.a shows a straightforward, easy-to-read program chunk
...
%
Figure~\ref{lst.direct}.b shows the same chunk in \CEU, with the noteworthy
...
%
\begin{itemize}
\item Make the runtime of \CEU to be interrupt driven and to put the
...
starts an analog-to-digital conversion asynchronously in the preipheral for
